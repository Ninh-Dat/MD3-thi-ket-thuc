...
<div class="container mt-4">
    <h1>Thêm sản phẩm</h1>
    <form method="post" action="{{route('sells.store')}}" enctype="multipart/form-data" class="container mt-3">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="manager" placeholder="Nhập tên">
